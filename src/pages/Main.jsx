...
const Main = () => {
  ...
  const urlNew = `https://api.themoviedb.org/3/search/movie/?api_key=${mapi_key}&query=${search.search1}&page=${page}`;
  const urlNew2 = `https://api.themoviedb.org/3/search/movie/?api_key=${mapi_key}&query=${search.search2}&page=${page}`;
